...
type Client struct {
	base *runtime.BaseClient[struct{}]
}
...
func NewClient(moduleName, moduleVersion string, plOpts runtime.PipelineOptions, options *ClientOptions) (*Client, error) {
	base, err := runtime.NewBaseClient[struct{}]("", moduleName, moduleVersion, plOpts, struct{}{}, options)
	if err != nil {
		return nil, err
	}
	return &Client{
...
func (c *Client) WithClientName(clientName string) *Client {
	base := c.base.WithClientName(clientName)
