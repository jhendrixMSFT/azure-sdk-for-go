...
func (s *ServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "Client.GetKeyRotationPolicy":
		resp, err = s.dispatchGetKeyRotationPolicy(req)
	case "Client.GetRandomBytes":
		resp, err = s.dispatchGetRandomBytes(req)
	case "Client.ImportKey":
		resp, err = s.dispatchImportKey(req)
	case "Client.NewListDeletedKeyPropertiesPager":
		resp, err = s.dispatchNewListDeletedKeyPropertiesPager(req)
	case "Client.NewListKeyPropertiesPager":
		resp, err = s.dispatchNewListKeyPropertiesPager(req)
	case "Client.NewListKeyPropertiesVersionsPager":
		resp, err = s.dispatchNewListKeyPropertiesVersionsPager(req)
	...
	case "Client.UpdateKeyRotationPolicy":
		resp, err = s.dispatchUpdateKeyRotationPolicy(req)
	case "Client.Verify":
