...
type Server struct {
	...
	BackupCertificate func(ctx context.Context, certificateName string, options *azcertificates.BackupCertificateOptions) (resp azfake.Responder[azcertificates.BackupCertificateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	DeleteCertificate func(ctx context.Context, certificateName string, options *azcertificates.DeleteCertificateOptions) (resp azfake.Responder[azcertificates.DeleteCertificateResponse], errResp azfake.ErrorResponder)

	// DeleteCertificateOperation is the fake for method Client.DeleteCertificateOperation
	// HTTP status codes to indicate success: http.StatusOK
	DeleteCertificateOperation func(ctx context.Context, certificateName string, options *azcertificates.DeleteCertificateOperationOptions) (resp azfake.Responder[azcertificates.DeleteCertificateOperationResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	DeleteIssuer func(ctx context.Context, issuerName string, options *azcertificates.DeleteIssuerOptions) (resp azfake.Responder[azcertificates.DeleteIssuerResponse], errResp azfake.ErrorResponder)

	// GetCertificate is the fake for method Client.GetCertificate
	// HTTP status codes to indicate success: http.StatusOK
	GetCertificate func(ctx context.Context, certificateName string, certificateVersion string, options *azcertificates.GetCertificateOptions) (resp azfake.Responder[azcertificates.GetCertificateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	GetCertificatePolicy func(ctx context.Context, certificateName string, options *azcertificates.GetCertificatePolicyOptions) (resp azfake.Responder[azcertificates.GetCertificatePolicyResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	GetDeletedCertificate func(ctx context.Context, certificateName string, options *azcertificates.GetDeletedCertificateOptions) (resp azfake.Responder[azcertificates.GetDeletedCertificateResponse], errResp azfake.ErrorResponder)

	// GetIssuer is the fake for method Client.GetIssuer
	// HTTP status codes to indicate success: http.StatusOK
	GetIssuer func(ctx context.Context, issuerName string, options *azcertificates.GetIssuerOptions) (resp azfake.Responder[azcertificates.GetIssuerResponse], errResp azfake.ErrorResponder)

	// ImportCertificate is the fake for method Client.ImportCertificate
	// HTTP status codes to indicate success: http.StatusOK
	ImportCertificate func(ctx context.Context, certificateName string, parameters azcertificates.ImportCertificateParameters, options *azcertificates.ImportCertificateOptions) (resp azfake.Responder[azcertificates.ImportCertificateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListCertificatePropertiesVersionsPager func(certificateName string, options *azcertificates.ListCertificatePropertiesVersionsOptions) (resp azfake.PagerResponder[azcertificates.ListCertificatePropertiesVersionsResponse])
	...
	MergeCertificate func(ctx context.Context, certificateName string, parameters azcertificates.MergeCertificateParameters, options *azcertificates.MergeCertificateOptions) (resp azfake.Responder[azcertificates.MergeCertificateResponse], errResp azfake.ErrorResponder)

	// PurgeDeletedCertificate is the fake for method Client.PurgeDeletedCertificate
	// HTTP status codes to indicate success: http.StatusNoContent
	PurgeDeletedCertificate func(ctx context.Context, certificateName string, options *azcertificates.PurgeDeletedCertificateOptions) (resp azfake.Responder[azcertificates.PurgeDeletedCertificateResponse], errResp azfake.ErrorResponder)

	// RecoverDeletedCertificate is the fake for method Client.RecoverDeletedCertificate
	// HTTP status codes to indicate success: http.StatusOK
	RecoverDeletedCertificate func(ctx context.Context, certificateName string, options *azcertificates.RecoverDeletedCertificateOptions) (resp azfake.Responder[azcertificates.RecoverDeletedCertificateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	SetIssuer func(ctx context.Context, issuerName string, parameter azcertificates.SetIssuerParameters, options *azcertificates.SetIssuerOptions) (resp azfake.Responder[azcertificates.SetIssuerResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	UpdateCertificateOperation func(ctx context.Context, certificateName string, certificateOperation azcertificates.UpdateCertificateOperationParameter, options *azcertificates.UpdateCertificateOperationOptions) (resp azfake.Responder[azcertificates.UpdateCertificateOperationResponse], errResp azfake.ErrorResponder)

	// UpdateCertificatePolicy is the fake for method Client.UpdateCertificatePolicy
	// HTTP status codes to indicate success: http.StatusOK
	UpdateCertificatePolicy func(ctx context.Context, certificateName string, certificatePolicy azcertificates.CertificatePolicy, options *azcertificates.UpdateCertificatePolicyOptions) (resp azfake.Responder[azcertificates.UpdateCertificatePolicyResponse], errResp azfake.ErrorResponder)

	// UpdateIssuer is the fake for method Client.UpdateIssuer
	// HTTP status codes to indicate success: http.StatusOK
	UpdateIssuer func(ctx context.Context, issuerName string, parameter azcertificates.UpdateIssuerParameters, options *azcertificates.UpdateIssuerOptions) (resp azfake.Responder[azcertificates.UpdateIssuerResponse], errResp azfake.ErrorResponder)
}
...
func (s *ServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "Client.DeleteContacts":
		resp, err = s.dispatchDeleteContacts(req)
	case "Client.DeleteIssuer":
		resp, err = s.dispatchDeleteIssuer(req)
	...
	case "Client.SetContacts":
		resp, err = s.dispatchSetContacts(req)
	case "Client.SetIssuer":
		resp, err = s.dispatchSetIssuer(req)
	...
	case "Client.UpdateIssuer":
		resp, err = s.dispatchUpdateIssuer(req)
	default:
...
func (s *ServerTransport) dispatchBackupCertificate(req *http.Request) (*http.Response, error) {
	...
	certificateNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("certificate_name")])
	if err != nil {
		return nil, err
	}
	respr, errRespr := s.srv.BackupCertificate(req.Context(), certificateNameParam, nil)
...
func (s *ServerTransport) dispatchCreateCertificate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.CreateCertificate(req.Context(), certificateNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchDeleteCertificate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.DeleteCertificate(req.Context(), certificateNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchDeleteCertificateOperation(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.DeleteCertificateOperation(req.Context(), certificateNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchDeleteIssuer(req *http.Request) (*http.Response, error) {
	...
	issuerNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("issuer_name")])
	if err != nil {
		return nil, err
	}
	respr, errRespr := s.srv.DeleteIssuer(req.Context(), issuerNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchGetCertificate(req *http.Request) (*http.Response, error) {
	...
	certificateVersionParam, err := url.PathUnescape(matches[regex.SubexpIndex("certificate_version")])
	if err != nil {
		return nil, err
	}
	respr, errRespr := s.srv.GetCertificate(req.Context(), certificateNameParam, certificateVersionParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchGetCertificateOperation(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.GetCertificateOperation(req.Context(), certificateNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchGetCertificatePolicy(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.GetCertificatePolicy(req.Context(), certificateNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchGetDeletedCertificate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.GetDeletedCertificate(req.Context(), certificateNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchGetIssuer(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.GetIssuer(req.Context(), issuerNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchImportCertificate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.ImportCertificate(req.Context(), certificateNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchNewListCertificatePropertiesVersionsPager(req *http.Request) (*http.Response, error) {
	...
	if newListCertificatePropertiesVersionsPager == nil {
		...
		resp := s.srv.NewListCertificatePropertiesVersionsPager(certificateNameParam, nil)
...
func (s *ServerTransport) dispatchMergeCertificate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.MergeCertificate(req.Context(), certificateNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchPurgeDeletedCertificate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.PurgeDeletedCertificate(req.Context(), certificateNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchRecoverDeletedCertificate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.RecoverDeletedCertificate(req.Context(), certificateNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchSetIssuer(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.SetIssuer(req.Context(), issuerNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchUpdateCertificate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.UpdateCertificate(req.Context(), certificateNameParam, certificateVersionParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchUpdateCertificateOperation(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.UpdateCertificateOperation(req.Context(), certificateNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchUpdateCertificatePolicy(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.UpdateCertificatePolicy(req.Context(), certificateNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchUpdateIssuer(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.UpdateIssuer(req.Context(), issuerNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
