...
type HopLinkProperties struct {
	...
	RoundTripTimeAvg *int32 `json:"roundTripTimeAvg,omitempty" azure:"ro"`

	// READ-ONLY; Maximum roundtrip time in milliseconds.
	RoundTripTimeMax *int32 `json:"roundTripTimeMax,omitempty" azure:"ro"`

	// READ-ONLY; Minimum roundtrip time in milliseconds.
	RoundTripTimeMin *int32 `json:"roundTripTimeMin,omitempty" azure:"ro"`
}
...
// VirtualNetworksGetBastionHostsOptions contains the optional parameters for the VirtualNetworks.GetBastionHosts method.
type VirtualNetworksGetBastionHostsOptions struct {
	// placeholder for future optional parameters
}
