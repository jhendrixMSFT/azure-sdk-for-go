...
func (client *VirtualNetworksClient) GetBastionHosts(ctx context.Context, resourceGroupName string, virtualNetworkName string, options *VirtualNetworksGetBastionHostsOptions) (BastionHostListResultResponse, error) {
	req, err := client.getBastionHostsCreateRequest(ctx, resourceGroupName, virtualNetworkName, options)
	if err != nil {
	...
	if !resp.HasStatusCode(http.StatusOK) {
		return BastionHostListResultResponse{}, client.getBastionHostsHandleError(resp)
	}
	return client.getBastionHostsHandleResponse(resp)
}

// getBastionHostsCreateRequest creates the GetBastionHosts request.
func (client *VirtualNetworksClient) getBastionHostsCreateRequest(ctx context.Context, resourceGroupName string, virtualNetworkName string, options *VirtualNetworksGetBastionHostsOptions) (*azcore.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/bastionHosts"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
// getBastionHostsHandleResponse handles the GetBastionHosts response.
func (client *VirtualNetworksClient) getBastionHostsHandleResponse(resp *azcore.Response) (BastionHostListResultResponse, error) {
...
// getBastionHostsHandleError handles the GetBastionHosts error response.
func (client *VirtualNetworksClient) getBastionHostsHandleError(resp *azcore.Response) error {
	var err CloudError
	if err := resp.UnmarshalAsJSON(&err); err != nil {
		return err
	}
