...
func (s *ServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "Client.NewListDeletedSecretPropertiesPager":
		resp, err = s.dispatchNewListDeletedSecretPropertiesPager(req)
	case "Client.NewListSecretPropertiesPager":
		resp, err = s.dispatchNewListSecretPropertiesPager(req)
	case "Client.NewListSecretPropertiesVersionsPager":
		resp, err = s.dispatchNewListSecretPropertiesVersionsPager(req)
	...
	case "Client.UpdateSecretProperties":
		resp, err = s.dispatchUpdateSecretProperties(req)
	default:
